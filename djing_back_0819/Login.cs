...
namespace DJing
{
    public partial class Login : Form
    {
        ...
        // 로그아웃 후 로그인 창을 다시 사용할 수 있도록 입력값을 초기화
        ...
        private void bt_FindAccount_Click(object sender, EventArgs e)
        {
            // 아이디/비밀번호 찾기 폼 객체 생성
            FindAccount findAccount = new FindAccount();

            // 찾기 창을 대화상자로 열어, 창을 닫기 전까지 로그인 창을 누를 수 없게 함
            findAccount.ShowDialog(this);
        }
    }
}
