namespace DJing
{
    partial class Choice
    {
        ...
        private void InitializeComponent()
        {
            ...
            // bt_Icon
            // 
            bt_Icon.BackColor = Color.FromArgb(60, 60, 60);
            bt_Icon.FlatStyle = FlatStyle.Popup;
            bt_Icon.Font = new Font("Microsoft Sans Serif", 9F, FontStyle.Bold, GraphicsUnit.Point);
            bt_Icon.ForeColor = Color.White;
            bt_Icon.Location = new Point(220, 38);
            bt_Icon.Name = "bt_Icon";
            bt_Icon.Size = new Size(160, 23);
            bt_Icon.TabIndex = 1;
            bt_Icon.Text = "회원정보 수정";
            bt_Icon.UseVisualStyleBackColor = false;
            bt_Icon.Click += bt_Icon_Click;
            // 
            // bt_Mixing
            // 
            bt_Mixing.BackColor = Color.FromArgb(60, 60, 60);
            bt_Mixing.FlatStyle = FlatStyle.Popup;
            bt_Mixing.Font = new Font("Microsoft Sans Serif", 9F, FontStyle.Bold, GraphicsUnit.Point);
            bt_Mixing.ForeColor = Color.White;
            ...
            bt_Mixing.UseVisualStyleBackColor = false;
            bt_Mixing.Click += bt_Mixing_Click;
            // 
            // bt_SoundCloud
            // 
            bt_SoundCloud.BackColor = Color.FromArgb(60, 60, 60);
            bt_SoundCloud.FlatStyle = FlatStyle.Popup;
            bt_SoundCloud.Font = new Font("Microsoft Sans Serif", 9F, FontStyle.Bold, GraphicsUnit.Point);
            bt_SoundCloud.ForeColor = Color.White;
            ...
            bt_SoundCloud.Text = "Sound Kloud";
            bt_SoundCloud.UseVisualStyleBackColor = false;
