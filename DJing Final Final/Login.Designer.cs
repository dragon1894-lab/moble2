namespace DJing
{
    partial class Login
    {
        ...
        private void InitializeComponent()
        {
            ...
            // bt_FindAccount
            // 
            bt_FindAccount.BackColor = Color.FromArgb(60, 60, 60);
            bt_FindAccount.FlatStyle = FlatStyle.Popup;
            bt_FindAccount.Font = new Font("맑은 고딕", 9.75F, FontStyle.Bold, GraphicsUnit.Point);
            bt_FindAccount.ForeColor = Color.White;
            bt_FindAccount.Location = new Point(350, 478);
            bt_FindAccount.Name = "bt_FindAccount";
            bt_FindAccount.Size = new Size(270, 36);
            bt_FindAccount.TabIndex = 5;
            bt_FindAccount.Text = "아이디 / 비밀번호 찾기";
            bt_FindAccount.UseVisualStyleBackColor = false;
            bt_FindAccount.Click += bt_FindAccount_Click;
            // 
            // pictureBox1
            // 
