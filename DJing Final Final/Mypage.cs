    ...
    public partial class Mypage : Form
    {
        ...
        private void btnBack_Click(object sender, EventArgs e)
        {
            ...
            mainForm.Controls.Add(
                mainForm.bottomPlayerPanel);

            mainForm.bottomPlayerPanel.Dock =
                DockStyle.Bottom;
        ...
        public void AttachBottomPlayer()
        {
            if (mainForm == null ||
                mainForm.bottomPlayerPanel == null)
            {
                return;
            }

            Controls.Add(mainForm.bottomPlayerPanel);
            mainForm.bottomPlayerPanel.Dock = DockStyle.Bottom;
            mainForm.bottomPlayerPanel.BringToFront();
        }
    }
}