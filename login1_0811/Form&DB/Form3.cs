        ...
        public Form3(string userName) // Form1에서 회원가입한 유저네임을 전달받음
        {
            ...
            using (MySqlConnection conn = DBHelper.GetConnection())
            {
                ...
                if (result != null && result != DBNull.Value)
                {
                    ...
                    {
                        case 1:
                            pb_Profile.Image = Properties.Resources.icon1;break;
                            
                        case 2:
                            pb_Profile.Image = Properties.Resources.icon2;break;
                            
                        case 3:
                            pb_Profile.Image = Properties.Resources.icon3;break;
                           
                        case 4:
                            pb_Profile.Image = Properties.Resources.icon4;break;
